...
import br.com.bicicletas.repository.UsuarioRepository;
...
public class ConfiguracaoSeguranca extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/bicicletas").permitAll()
				.antMatchers(HttpMethod.GET, "/bicicletas/*").permitAll().antMatchers(HttpMethod.POST, "/auth")
